...
class Form{
    ...
    public function Selectadd(string $options,string $name,int $value) {
        ...
        <option value='$value'>Hamster</option>
        <option value='$value'>Parrot</option>
        <option value='$value'>Spider</option>
        <option value='$value'>Goldfish</option>
        </select>";
        return $this;
    }
